...
//抢购结果返回格式
if( !function_exists('snapReturn')) {
    function snapReturn($success = FALSE, $code = '', $msg = '', $data = '') {
        $params = ['success' => $success, 'code' => $code , 'message' => $msg, 'data' => $data];
...
if( !function_exists('returnData')) {
    function returnData($success = FALSE, $msg = '', $data = '') {
        $params = ['success' => $success, 'message' => $msg, 'data' => $data];
        exit(json_encode($params));
    }
}
//返回结果数据
if( !function_exists('isIntNum')) {
    function isIntNum ($x) {
